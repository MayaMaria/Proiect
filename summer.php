      ...
      <div class="galery">
		...
		?>
		  ...
		  if(isset($_SESSION['login'])){
			  ?>
			  <form method="POST" action="phpfiles/rating3.php">
        ...
        <div class="column2">
		  ...
		  if(isset($_SESSION['login'])){
			  ?>
			   <form method="POST" action="phpfiles/rating3.php">
				<fieldset class="stars">
					<input type="submit" id="star5" name="stars1" value="5" />
					<label class="full" for="star5" title="Awesome"></label>
					<input type="submit" id="star4" name="stars1" value="4" />
					<label class="full" for="star4" title="Pretty good"></label>
					<input type="submit" id="star3" name="stars1" value="3" />
					<label class="full" for="star3" title="Ok"></label>
					<input type="submit" id="star2" name="stars1" value="2" />
					<label class="full" for="star2" title="Kinda bad"></label>
					<input type="submit" id="star1" name="stars1" value="1" />
        ...
        <div class="column2">
		  ...
		  if(isset($_SESSION['login'])){
			  ...
			  <form method="POST" action="phpfiles/rating3.php">
					<fieldset class="stars">
						<input type="submit" id="star10" name="stars" value="5" />
						<label class="full" for="star10" title="Awesome"></label>
						<input type="submit" id="star9" name="stars" value="4" />
						<label class="full" for="star9" title="Pretty good"></label>
						<input type="submit" id="star8" name="stars" value="3" />
						<label class="full" for="star8" title="Ok"></label>
						<input type="submit" id="star7" name="stars" value="2" />
						<label class="full" for="star7" title="Kinda bad"></label>
						<input type="submit" id="star6" name="stars" value="1" />
