      ...
      <div class="galery">
		  ...
		  if(isset($_SESSION['login'])){
			  ...
			  <form>
				<fieldset class="stars">
					<input type="radio" id="star15" name="stars2" value="5" onclick="getVote(this.value,46,'poll')" />
					<label class="full" for="star15" title="Very Good"></label>
					<input type="radio" id="star14" name="stars2" value="4" onclick="getVote(this.value,46,'poll')" />
					<label class="full" for="star14" title="Pretty good"></label>
					<input type="radio" id="star13" name="stars2" value="3" onclick="getVote(this.value,46,'poll')"/>
					<label class="full" for="star13" title="Ok"></label>
					<input type="radio" id="star12" name="stars2" value="2" onclick="getVote(this.value,46,'poll')"/>
					<label class="full" for="star12" title="Kinda bad"></label>
					<input type="radio" id="star11" name="stars2" value="1" onclick="getVote(this.value,46,'poll')"/>
        ...
        <?php
          ...
          <p class="buton-share">
		   ...
		   data-text="Pair with a cute miniskirt for the ultimate `90s feel "
		   data-url="http://M&amp;Ainspiration.com" 
		   data-via="m&amp;aInsipiration" 
		   data-hashtags="summerIsCallingYourName!" 
		    data-lang="en"
        ...
        <div class="column2">
		  ...
		  if(isset($_SESSION['login'])){
			  ...
			  <div id="poll2">
			   <form>
				<fieldset class="stars">
					<input type="radio" id="star5" name="stars1" value="5" onclick="getVote(this.value,47,'poll2')"/>
					<label class="full" for="star5" title="Awesome"></label>
					<input type="radio" id="star4" name="stars1" value="4" onclick="getVote(this.value,47,'poll2')" />
					<label class="full" for="star4" title="Pretty good"></label>
					<input type="radio" id="star3" name="stars1" value="3" onclick="getVote(this.value,47,'poll2')"/>
					<label class="full" for="star3" title="Ok"></label>
					<input type="radio" id="star2" name="stars1" value="2" onclick="getVote(this.value,47,'poll2')"/>
					<label class="full" for="star2" title="Kinda bad"></label>
					<input type="radio" id="star1" name="stars1" value="1" onclick="getVote(this.value,47,'poll2')"/>
		...
		<?php
          ...
          <p class="buton-share">
             <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button"
		   data-text="Socks and sandals? Counts us in"
		   data-url="http://M&amp;Ainspiration.com" 
		   data-via="m&amp;aInsipiration" 
		   data-hashtags="summerIsCallingYourName!"
		   data-lang="en"
        ...
        <div class="column2">
		  ...
		  if(isset($_SESSION['login'])){
			  ...
			  <form>
					<fieldset class="stars">
						<input type="radio" id="star10" name="stars" value="5" onclick="getVote(this.value,48,'poll3')"/>
						<label class="full" for="star10" title="Awesome"></label>
						<input type="radio" id="star9" name="stars" value="4" onclick="getVote(this.value,48,'poll3')"/>
						<label class="full" for="star9" title="Pretty good"></label>
						<input type="radio" id="star8" name="stars" value="3" onclick="getVote(this.value,48,'poll3')"/>
						<label class="full" for="star8" title="Ok"></label>
						<input type="radio" id="star7" name="stars" value="2" onclick="getVote(this.value,48,'poll3')"/>
						<label class="full" for="star7" title="Kinda bad"></label>
						<input type="radio" id="star6" name="stars" value="1" onclick="getVote(this.value,48,'poll3')"/>
		...
		<?php
          ...
          <p class="buton-share">
            <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button"
			data-text="A pair of strappy sandals will always look great with a maxi skirt" 
			data-url="http://M&amp;Ainspiration.com" 
			data-via="m&amp;aInsipiration" 
			data-hashtags="summerIsCallingYourName!"
			data-lang="en"
